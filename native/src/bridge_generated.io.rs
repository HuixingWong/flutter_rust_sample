...
#[no_mangle]
pub extern "C" fn wire_draw_tree(port_: i64, tree: *mut wire_uint_32_list) {
    wire_draw_tree_impl(port_, tree)
}
...
#[no_mangle]
pub extern "C" fn wire_fucking(port_: i64) {
    wire_fucking_impl(port_)
}
